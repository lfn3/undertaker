...
public void %s() { ... }"
          name
          (:undertaker.core/iterations-run results)
          (vec (:undertaker.core/shrunk-values results))
          (vec (:undertaker.core/generated-values results))
          (:undertaker.core/seed results)
          name
          (:undertaker.core/seed results)
          (:undertaker.core/seed results)
          name))
